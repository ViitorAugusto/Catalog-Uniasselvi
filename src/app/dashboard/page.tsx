            ...
            <div className="mt-auto p-4">
              <Card>
                <CardHeader className="pb-4">
                  ...
                  <CardDescription>
                    Click the button to add a new product to your inventory.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell className="font-medium">Acme Lamp</TableCell>
                    <TableCell className="hidden md:table-cell">
                      A stylish and energy-efficient lamp for your home.
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="hidden md:table-cell">
                      A durable and comfortable backpack for everyday use.
                    </TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="hidden md:table-cell">
                      A reusable and leak-proof water bottle for on-the-go
                      hydration.
                    </TableCell>
